...
export default function Footer() {
  ...
  return (
    <footer className="relative py-24 bg-[#020617] border-t border-zinc-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-3 gap-12 items-center mb-16">
          ...
          <div className="hidden md:flex flex-col gap-2 font-mono text-[10px] text-zinc-600 uppercase tracking-widest">
            ...
            <p>System_Time: {time || "00:00:00"}</p>
          </div>

          <div className="text-center">
            <h2 className="text-2xl font-black text-white italic tracking-tighter mb-4">
              NOVATECH <span className="text-cyan-500">FEST</span>
            </h2>
            <p className="text-xs text-zinc-500 font-mono tracking-[0.3em] uppercase mb-8">
              © 2026 • Protocol_Alpha_Enabled
            </p>
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
             <button className="relative px-8 py-3 bg-transparent border border-cyan-500/50 text-cyan-400 font-mono text-xs uppercase tracking-[0.2em] overflow-hidden group">
                <span className="relative z-10 group-hover:text-black transition-colors duration-300">Join Community</span>
             ...
             <p className="text-[9px] text-zinc-700 font-mono">ENCRYPTED_ENROLLMENT_OPEN</p>
          </div>
